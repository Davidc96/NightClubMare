...
using RekordboxNFSLibrary.Protocols.Commons.Exceptions;
using RekordboxNFSLibrary.Protocols.Commons.Exceptions.Mount;
using RekordboxNFSLibrary.Protocols.V2.RPC;
using RekordboxNFSLibrary.Protocols.V2.RPC.Mount;
using org.acplt.oncrpc;
using System;
using System.Collections.Generic;
using System.Net;

namespace RekordboxNFSLibrary.Protocols.V2
{
    public class NFSv2 : INFS
    {
        ...
        public void Connect(IPAddress Address, int UserID, int GroupID, int ClientTimeout, System.Text.Encoding characterEncoding, bool useSecurePort, bool useCache)
        {
            ...
            OncRpcClientAuthUnix authUnix = new OncRpcClientAuthUnix("", UserID, GroupID);
